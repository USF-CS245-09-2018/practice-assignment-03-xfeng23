...
//	
	public int find_min_recursive() {
		...
		find_min_recurisive(arr, 0, maxValue);
		return resIndex;
	}

	public void find_min_recurisive(double[] array, int index, double maxValue) {

		// return case
		if (index == array.length) return;
		else if (array[index] < maxValue) {
			resIndex = index;
			find_min_recurisive(array, index + 1, array[resIndex]);
		}
		else find_min_recurisive(array, index + 1, maxValue);
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("running time for 'find_min_recurisve': " + totalTime2 + " nanoseconds.");
